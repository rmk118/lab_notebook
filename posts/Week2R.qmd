...
After learning some GIS basics, I started working with some data sets I found online in hopes of getting the SMAST data that has time series of scallop abundance alongside the abundance of major scallop predators. ([This survey, which is still ongoing](http://www.repstraus.com/wp-content/uploads/2015/03/SMAST-drop-cam-survey-1999-2014-Stokesbury.pdf).)
