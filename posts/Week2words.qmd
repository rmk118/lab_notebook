...
I first spent some time reorganizing this lab notebook so it would be easier to follow my work (e.g., putting all the code in one place).

Although I was extremely frustrated to learn I had spent hours searching for data I already had, I did find a wealth of information about the methodology and history of the sea scallop survey itself. I also discovered several other sources of sea scallop and benthic habitat data, which may be useful later in my project.
