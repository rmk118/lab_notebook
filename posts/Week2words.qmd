...
While I was frustrated to learn I had spent so much time searching for data I already had, I did find a wealth of information about the methodology and history of the sea scallop survey itself. First, the scallop survey data I pulled from NOAA extended through 2022, a year beyond the version Dr. Deyle shared with me. I also discovered several other sources of sea scallop and benthic habitat data, which may be useful later in my project. In fact, I became highly immersed in the scallop literature, and found so much information that I started to create a separate page for this site titled "Scallop Links". I now have a relatively thorough understanding of the current landscape of Atlantic sea scallop research, and many exciting ideas for meaningful analyses I could perform once I get the data in a more workable format. Overall, I think today I made good progress towards being able to use real scallop data to test hypotheses and answer meaningful questions.

# Thursday, June 15

(Outline/draft)
- Made scallop resources page with all the papers and links I have read (or at least briefly skimmed) over the past week.
- Looked for SMAST drop camera data
- Learned basics of GIS, downloaded software, figured out how to do it in R instead
- Started spatial analysis in R
- Took a break and looked for station data

Without the station data, it would be hard to conduct a meaningful spatial analyses, since the strata are relatively coarse. I ended up pulling the scallop survey data for a third time (from here), and this time the station file was not missing any years!

For next week: will work with full NEFSC scallop survey data set, possibly explore the spatial data more 
