...
We will use the "surrogate" function from the package tseries, which will create surrogate data with the same spectrum as the input time series (x) by randomizing the phases of the Fourier coefficients of x.