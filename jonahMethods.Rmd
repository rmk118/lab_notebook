...
data. TEST THIS ON INDIVIDUAL AREAS
...
# Cross-map skill at max lib size
...
We will use the "surrogate" function from the package tseries, which will create surrogate data with the same spectrum as the input time series (x) by randomizing the phases of the Fourier coefficients of x, and we'll set "amplitude=TRUE" to preserve the amplitude distribution of the original series.
...
On to areas. We're going to define a quick help function to find the max cross-map skill from the actual time series.
